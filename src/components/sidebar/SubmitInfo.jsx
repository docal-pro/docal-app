...
export const SubmitInfo = () => {
  ...
  return (
    <div className="w-full md:mt-12 lg:mt-12">
      ...
      <h3 className="text-md lg:text-lg font-bold text-center mb-4 bg-gradient-to-br from-gray-300 to-gray-200 bg-clip-text text-transparent font-ocr tracking-tight"></h3>

      <div className="max-w-xl mx-auto h-6 lg:mt-1 mb-16"></div>
      {isModalOpen && (
