                ...
                <form onSubmit={handleSubmit} className="relative flex flex-col gap-4">
                    <div className="flex flex-col justify-center items-center my-4 gap-4">
                        <div className="flex items-center space-x-3">
                            <span className={`${mode === 'Post' ? "text-gray-600" : "text-green-600"} text-sm`}>
                            ...
                            <span className={`${mode === 'Profile' ? "text-gray-600" : "text-green-600"} text-sm`}>{" "}
                                <span className="relative group">
                                    <span className="cursor-pointer">
                    ...
                    <div className="relative flex items-center w-full">
                        <div className="max-w-xl mx-auto w-full">
                            <Dropdown selectedClass={selectedClass} setSelectedClass={setSelectedClass} options={scamDiscourseClassifiers} disabled={(!forumUrl || !validateForumUrl(forumUrl)) && mode === 'Profile'} />
                        </div>
                        <span className="relative group ml-4">
                            <span className="cursor-pointer text-xs lg:text-lg text-gray-500">
                                &#9432;
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            placeholder={mode === 'Profile' ? "Enter Discourse Username" : "Enter Discourse Post Link"}
                        ...
                        <button
                            ...
                            disabled={!selectedClass}
                            className={`px-6 py-3 ${mode === 'Post' ? "bg-green-600" : "bg-green-600"} border ${mode === 'Post' ? "border-green-600" : "border-green-600"} hover:bg-transparent rounded-r-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed`}
                        >
